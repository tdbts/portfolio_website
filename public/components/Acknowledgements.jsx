			...
			scrollableSections: [
				{
					...
					content: (
						<div className="scrollable_section_content">
							<div id="appreciation_section_title" className="acknowledgements_section_title">
								<h4 className="lead">Appreciation</h4>
							</div>
							<div id="appreciation_section_text" className="acknowledgements_section_text">
				...
				}, 
				{
					...
					content: (
						<div className="scrollable_section_content">
							<div id="webpage_section_title" className="acknowledgements_section_text">
								<h4 className="lead">Webpage</h4>
							</div>
							<div id="webpage_section_text" className="acknowledgements_section_text">
				...
				},  
				{
					...
					content: (
						<div className="scrollable_section_content">
							<div id="home_section_title" className="acknowledgements_section_title">
								<h4 className="lead">Home</h4>
							</div>
							<div id="home_section_text" className="acknowledgements_section_text">
				...
				}, 
				{
					...
					content: (
						<div className="scrollable_section_content">
							<div id="tweet_cloud_section_title" className="acknowledgements_section_title">
								<h4 className="lead">Tweet Cloud</h4>
							</div>
							<div id="tweet_cloud_section_text" className="acknowledgements_section_text">
				...
				}, 
				{
					...
					content: (
						<div className="scrollable_section_content">
							<div id="contact_section_title" className="acknowledgements_section_title">
								<h4 className="lead">Contact</h4>
							</div>
							<div id="contact_section_text" className="acknowledgements_section_text">
