...
},{"./AccordionPanelBody":159,"./AccordionPanelHeading":160,"react":157}],159:[function(require,module,exports){
var React = require('react');
...
},{"./AcknowledgementsNav":161,"./AcknowledgementsScrollable":163,"react":157}],163:[function(require,module,exports){
var React = require('react'), 
...
var FeedCloudOptions = React.createClass({displayName: "FeedCloudOptions",
	render: function () {
		return (
			React.createElement("div", {className: "options", id: "feedCloudOptions"}, 
				React.createElement("p", null, "Options:"), 
				React.createElement("button", {type: "button", id: "getTenPreviousTweets", className: "btn btn-primary btn-xs"}, "Get Ten Previous Tweets"), 
				React.createElement("button", {type: "button", className: "btn btn-primary btn-xs clearAll"}, "Clear Tags")
			)			
		);
	}
});
	...
	determineViewToRender: function () {
		...
		var views = {
			...
			tweetCloud: {
				...
				component: React.createElement(TweetCloud, null)
			}
		};
...
var SearchCloudOptions = React.createClass({displayName: "SearchCloudOptions",
	render: function () {
		return (
			React.createElement("div", {className: "options", id: "searchCloudOptions"}, 
				React.createElement("p", null, "Options:"), 
				React.createElement("button", {type: "button", id: "stopCloudAutoRefresh", className: "btn btn-primary btn-xs"}, "Stop Cloud Auto Refresh"), 
				React.createElement("button", {type: "button", className: "btn btn-primary btn-xs clearAll"}, "Clear Tags"), 
				React.createElement("button", {type: "button", id: "progress_button", className: "btn btn-success btn-xs"}, "Seconds Left")
			) 
		);
	}
});
...
var TweetCloud = React.createClass({displayName: "TweetCloud",
	componentDidMount: function () {
	...
	render: function () {
		return (
			React.createElement("div", {id: "tweet_cloud_background", className: "fullHeightWidth"}, 
				React.createElement("div", {id: "tweet_cloud_info_container", className: "container"}, 
					React.createElement("div", {id: "tweet_cloud_header_container"}, 
						React.createElement("h1", {id: "tweet_cloud_header", className: "page-header col-xs-10"}, "Tweet Cloud")
					), 
					React.createElement("div", {className: "row"}, 
						React.createElement("div", {className: "col-md-4"}, 
							React.createElement("div", {id: "tweet_cloud_menu_container"}, 
								React.createElement(TweetCloudMenu, {accordionID: "tweet_cloud_menu_accordion"})
							)
						), 
						React.createElement("div", {className: "col-md-4"}, 
							React.createElement(TweetCloudSearchInput, {inputID: "feed_cloud_input", inputHeader: "Create a Cloud From Your Twitter Feed", inputPrompt: "Enter Your Twitter Handle: ", buttonText: "Create Feed Cloud"})
						), 
						React.createElement("div", {className: "col-md-4"}, 
							React.createElement(TweetCloudSearchInput, {inputID: "search_cloud_input", inputHeader: "Create a Cloud From Your Twitter Search", inputPrompt: "Enter Your Search Term: ", buttonText: "Create Search Cloud"})
						)
					)
				), 
				React.createElement(TweetCloudImageModal, null), 
				React.createElement("div", {id: "cloudParent"}, 
					React.createElement("div", {id: "clouder"})
				)
			)			
		);
	}
...
var TweetCloudImageModal = React.createClass({displayName: "TweetCloudImageModal",
	render: function () {
		return (
			React.createElement("div", {className: "modal fade", id: "imageModal", tabindex: "-1", role: "dialog", "aria-labelledby": "imageModalLabel", "aria-hidden": "true"}, 
				React.createElement("div", {className: "modal-dialog"}, 
					React.createElement("div", {className: "modal-content"}, 
						React.createElement("div", {className: "modal-header"}, 
							React.createElement("button", {type: "button", className: "close modal_close", "data-dismiss": "modal"}, React.createElement("span", {"aria-hidden": "true"}, "×"), React.createElement("span", {className: "sr-only"}, "Close")), 
							React.createElement("h4", {className: "modal-title", id: "imageModalLabel"})
						), 
						React.createElement("div", {className: "modal-body"}, 
							React.createElement("div", {id: "image_container"}, 
								React.createElement("img", {id: "tweet_image", src: "#", alt: "Picture from Tweet"})
							)
						), 
						React.createElement("div", {className: "modal-footer"}, 
							React.createElement("button", {type: "button", className: "btn btn-primary modal_close", "data-dismiss": "modal"}, "Close")
						)
					)
				)
			)			
...
var TweetCloudMenu = React.createClass({displayName: "TweetCloudMenu",
	...
	render: function () {
		return (
			React.createElement("div", {className: "panel-group", id: this.props.accordionID, role: "tablist", "aria-multiselectable": "true"}, 
				React.createElement(AccordionPanel, {ref: "openByDefaultPanel", panelType: "default", headingID: this.getPanelHeadingID("what_it_is"), accordionID: this.props.accordionID, collapseID: this.getPanelCollapseID("what_it_is"), expandedByDefault: "true", headingText: "What It Is", bodyContent: React.createElement(TweetCloudMenuBodyWhatItIs, null)}), 
				React.createElement(AccordionPanel, {panelType: "default", headingID: this.getPanelHeadingID("how_it_works"), accordionID: this.props.accordionID, collapseID: this.getPanelCollapseID("how_it_works"), headingText: "How It Works", bodyContent: React.createElement(TweetCloudMenuBodyHowItWorks, null)}), 
				React.createElement(AccordionPanel, {panelType: "default", headingID: this.getPanelHeadingID("search_options"), accordionID: this.props.accordionID, collapseID: this.getPanelCollapseID("search_options"), headingText: "Search Options", bodyContent: React.createElement(TweetCloudMenuBodySearchOptions, null)})
			)
		);
	}
});
...
var TweetCloudMenuBodyHowItWorks = React.createClass({displayName: "TweetCloudMenuBodyHowItWorks",
	render: function () {
		return (
			React.createElement("div", {id: "how_it_works_content"}, 
				React.createElement("p", null, "You can move the cloud around with your mouse, and one tweet at a time will be highlighted.  When you click inside the cloud, you will activate the highlighted tweet, which means:"), 
				React.createElement("ul", {id: "how_it_works_list"}, 
					React.createElement("li", null, "If the the tweet contains a link, your browser will ask if you'd like to go to that page."), 
					React.createElement("li", null, "If the tweet has a picture, the page will display that picture."), 
					React.createElement("li", null, "If the tweet has neither, the text of the tweet will be shown.")				
				)
			)
		);
	}
...
var TweetCloudMenuBodySearchOptions = React.createClass({displayName: "TweetCloudMenuBodySearchOptions",
	render: function () {
		return (
			React.createElement("div", {id: "search_options_container"}, 
				React.createElement("p", null, "There are two kinds of Tweet Clouds you can create:"), 
				React.createElement("ol", {id: "tweet_cloud_types_list"}, 
					React.createElement("li", null, 
						"Feed Cloud: Make one using anyone's Twitter handle.", 
						React.createElement("ul", null, 
							React.createElement("li", null, 
								React.createElement("h6", null, React.createElement("em", null, "Examples: Earth_Pics, HistoryInPics, BabyAnimalPics"))
							)
						)
					), 
				  	React.createElement("li", null, 
						...
						React.createElement("ul", null, 
							React.createElement("li", null, 
								React.createElement("h6", null, React.createElement("em", null, "Examples: NYC, SuperBowl, CrossFit"))
							)
						)
				  	)
				), 
				React.createElement("p", null, "You can manually refresh the Feed Cloud with ten previous tweets, while the Search Cloud will automatically refresh with more tweets.  Have fun!"), 			
				React.createElement(TweetCloudOptions, null)
			)
		);
	}
});
...
var TweetCloudMenuBodyWhatItIs = React.createClass({displayName: "TweetCloudMenuBodyWhatItIs",
	render: function () {
		return (
			React.createElement("div", {id: "what_it_is_content", className: "tweet_cloud_menu_item"}, 
				React.createElement("p", null, "Welcome to the Tweet Cloud. This web app uses Twitter to retrieve tweets, and arranges them into an interactive three-dimensional sphere. ")
			)
		);
	}
});
...
var TweetCloudOptions = React.createClass({displayName: "TweetCloudOptions",
	render: function () {
		return (
			React.createElement("div", {id: "tweet_cloud_options_container"}, 
				React.createElement(FeedCloudOptions, null), 
				React.createElement(SearchCloudOptions, null)
			)
		);
	}
});
...
var TweetCloudSearchInput = React.createClass({displayName: "TweetCloudSearchInput",
	render: function () {
		return (
			React.createElement("div", {id: this.props.inputID + "_container", className: "tweet_cloud_input_container"}, 
				React.createElement("h4", {className: "cloudTitle"}, this.props.inputHeader), 
				React.createElement("p", null, this.props.inputPrompt), 
				React.createElement("div", {className: "input-group"}, 
					React.createElement("input", {type: "text", name: this.props.inputID, className: "inputField", id: this.props.inputID}), 
					React.createElement("button", {type: "button", id: this.props.inputID + "_button", className: "btn btn-primary btn-xs"}, this.props.buttonText)
				)
			)			
		);
	}
